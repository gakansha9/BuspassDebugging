...
public class VehicleDAO implements DAO<Vehicle> {
	...
	public int insert(Vehicle object) {
		String sql = "INSERT INTO Vehicles (registrationNumber, totalSeats, filledSeats, routeId, type, vehicleStatus, startPickUpTime, startDropOffTime, adminId, driverID) "
	...
	public int update(Vehicle object) {
		String sql = "UPDATE Vehicles set registrationNumber = '"+object.registrationNumber+"', totalSeats = "+object.totalSeats+", filledSeats = "+object.filledSeats+", routeId = "+object.routeId+", type = "+object.type+", vehicleStatus = "+object.vehicleStatus+", startPickUpTime = '"+object.startPickUpTime+"', startDropOffTime = '"+object.startDropOffTime+"', driverID = "+object.driverID+" WHERE id = "+object.id;
		return db.executeSQL(sql);
	}
