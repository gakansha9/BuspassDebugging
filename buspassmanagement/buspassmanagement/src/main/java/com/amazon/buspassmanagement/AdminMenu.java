	...
	public void showMenu() {
		...
		if(result && adminUser.type == 1) {
			...
			while(true) {
	        	...
	        	System.out.println("6: Enhance Features");
	        	System.out.println("7: Quit Admin App");
	        	...
	        	switch (choice) {
					...
					case 6:
						System.out.println("1: Delete Route With Related Vehicles/Stops");
						System.out.println("2: View Expired Buspass");
						System.out.println("3: View Passes With Specific Date Range");
						System.out.println("Enter Your Choice: ");
						
			        	int Choice = Integer.parseInt(scanner.nextLine());
			        	
			        	if(Choice == 1) {
			        		routeService.deleteRoutevehicle();
						}else if(Choice == 2) {
							passService.viewExpiredPass();
						}else if(Choice == 3) {
							passService.viewBetweenDatePass();
