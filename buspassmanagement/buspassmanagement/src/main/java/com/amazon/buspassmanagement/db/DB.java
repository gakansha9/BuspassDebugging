...
public class DB {
	...
	public static String FILEPATH = "C:\\Users\\guakansh\\Desktop\\Working forlder\\Atlas\\Project Development\\Project for Debugging - Buss Pass\\Debugging\\buspassmanagement\\buspassmanagement\\src\\main\\java\\dbconfig.txt";
	public static String URL = "jdbc:sqlserver://localhost:1433;databaseName=project;integratedSecurity=false;encrypt=true;trustServerCertificate=true";
	public static String USER = "atlas";
	public static String PASSWORD = "atlas";
	
	//String url = "jdbc:sqlserver://localhost:1433; databaseName=buspass; user=java2;password=java; integratedSecurity=false; encrypt=true;trustServerCertificate=true";
...
//			System.out.println("[DB] Connection Created Successfully....");
			...
			// MS-SQL
			String url = "jdbc:sqlserver://localhost:1433; databaseName=project;integratedSecurity=false; encrypt=true;trustServerCertificate=true";
			connection = DriverManager.getConnection(url, USER, PASSWORD);
			System.out.println("[DB] Connection Created Successfully....");
