...
public class RouteService {
	...
	public void deleteRoutevehicle() {
		Route route = new Route();

		System.out.println("Enter Route ID to be deleted: ");
		int id = Integer.parseInt(scanner.nextLine());

		String sql1 = "delete from stops where routeid=" + id;
		int result1 = db.executeSQL(sql1);
		String sql2 = "delete from vehicles where routeid=" + id;
		int result2 = db.executeSQL(sql2);
		String sql3 = "delete from routes where id=" + id;
		int result3 = db.executeSQL(sql3);

		String message = (result1 > 0 && result2 > 0 && result3 > 0) ? "Route Deleted Successfully"
				: "Deleting Route Failed. Try Again..";
		System.out.println(message);
	}
	...
	public void viewRoutes() {
		...
		if (routeId != 0 && route != null) {
			...
			System.out.println("~~~~~~~~~~~~~~~");
			String sql = "SELECT * from Stops where routeId = " + routeId;
	...
	public void viewVehicles() {
		...
		if (routeId == 0) {
			...
			String sql = "SELECT * from Vehicles where routeId = " + routeId;
